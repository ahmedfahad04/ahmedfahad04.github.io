...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="text-gray-400 bg-gray-900 body-font h-screen"
    >
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
            Hi, I'm <span className="text-secondary">Istiaq Ahmed Fahad.</span>
          ...
          <p className="mb-8 leading-relaxed">
            Assalamu Alaikum, It's Istiaq Ahmed Fahad, a passionate Software
            Engineer who loves to spent his minutes in coding and exploring. He
            is quite comfortable with Frontend Development. Also he has a great
            fascination for Artifical Intelligence specially in NLP. Currently
            he is pursuing his Bachelors' in IIT, University of Dhaka
          </p>
          <div className="flex justify-center">
            <a
              href="documents/Fahad.pdf"
              download
              className="inline-flex text-primary text-center bg-secondary border-0 py-2 px-6 focus:outline-none hover:bg-yellow-400 rounded text-lg"
            >
              Download CV
            </a>
            <a
              href="https://www.github.com/ahmedfahad04"
              target="blank"
            ...
            >
              <div className="flex flex-row items-center justify-center">
                ...
                <span className="ml-3 text-center"> Check github</span>
              </div>
            </a>
          </div>
        </div>
