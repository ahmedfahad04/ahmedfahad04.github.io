      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-tada-accepted-for-publication-in-enase-2026-promptmark-a-prompt-guided-iterative-feedback-framework-for-source-code-watermarking",
          title: ':tada: Accepted for Publication in ENASE 2026: “PromptMark: A Prompt-Guided Iterative-Feedback Framework for...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%68%6D%65%64%66%61%68%61%64%33%35%39%36@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=4nnVAk0AAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/ahmedfahad04", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ahmedfahad04", "_blank");
        },
      },{
        id: 'social-medium',
        title: 'Medium',
        section: 'Socials',
        handler: () => {
          window.open("https://medium.com/@ahmedfahad04", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
