...
<div class="publications">
	<h2 class="bibliography">Research Experience</h2>
	<ol class="bibliography">
		<li>
			<div class="row">
				<div class="col-sm-2 abbr">
					<abbr class="badge rounded w-100">BIDS</abbr>
					<div class="author" style="margin-top: 0.5em; text-align: center;">Research Assistant (RA)</div>
				</div>
				<div class="col-sm-8">
					<div class="title">Bangladesh Institute of Development Studies (BIDS)</div>
					<div class="periodical"><em>Advisor: <a href="#">Dr. Atonu Rabbani</a>, Economics, University of Dhaka.</em></div>
		...
		<li>
			<div class="row">
				<div class="col-sm-2 abbr">
					<abbr class="badge rounded w-100">DSSE</abbr>
					<div class="author" style="margin-top: 0.5em; text-align: center;">Research Assistant (RA)</div>
				</div>
				<div class="col-sm-8">
					<div class="title">Distributed Systems and Software Engineering (DSSE) Research Group</div>
					<div class="periodical"><em>Advisor: <a href="#">Dr. Kazi Muheymin-Us-Sakib</a>, IIT, University of Dhaka.</em></div>
		...
		<li>
			<div class="row">
				<div class="col-sm-2 abbr">
					<abbr class="badge rounded w-100">DnD Lab</abbr>
					<div class="author" style="margin-top: 0.5em; text-align: center;">Research Assistant (RA)</div>
				</div>
				<div class="col-sm-8">
					<div class="title">Data and Design Lab (DnD Lab)</div>
					<div class="periodical"><em>Advisor: <a href="#">Dr. Moinul Islam Zaber</a> and <a href="#">Dr. Sarker Tanveer Ahmed Rumee</a>, CSE, University of Dhaka.</em></div>
		...
		<li>
			<div class="row">
				<div class="col-sm-2 abbr">
					<abbr class="badge rounded w-100">UIUC+</abbr>
					<div class="author" style="margin-top: 0.5em; text-align: center;">Research Intern</div>
				</div>
				<div class="col-sm-8">
					<div class="title">UIUC+ Summer Research Program in Software Engineering (SRSE)</div>
					<div class="periodical"><em>Advisor: <a href="#">Darko Marinov</a>, University of Illinois at Urbana-Champaign.</em></div>
	...
	<h2 class="bibliography">Professional Experience</h2>
	<ol class="bibliography">
		<li>
			<div class="row">
				<div class="col-sm-2 abbr">
					<abbr class="badge rounded w-100">IIT</abbr>
					<div class="author" style="margin-top: 0.5em; text-align: center;">Course Instructor</div>
				</div>
				<div class="col-sm-8">
					<div class="title">IIT, University of Dhaka</div>
		...
		<li>
			<div class="row">
				<div class="col-sm-2 abbr">
					<abbr class="badge rounded w-100">Cefalo</abbr>
					<div class="author" style="margin-top: 0.5em; text-align: center;">Trainee Software Engineer</div>
				</div>
				<div class="col-sm-8">
					<div class="title">Cefalo Bangladesh Limited</div>
		...
		<li>
			<div class="row">
				<div class="col-sm-2 abbr">
					<abbr class="badge rounded w-100">Vivasoft</abbr>
					<div class="author" style="margin-top: 0.5em; text-align: center;">Software Engineer Intern</div>
				</div>
				<div class="col-sm-8">
					<div class="title">Vivasoft Limited</div>
		...
		<li>
			<div class="row">
				<div class="col-sm-2 abbr">
					<abbr class="badge rounded w-100">ERP</abbr>
					<div class="author" style="margin-top: 0.5em; text-align: center;">Assistant ERP System Analyst</div>
				</div>
				<div class="col-sm-8">
					<div class="title">Chittagong University ERP Project</div>
		...
		<li>
			<div class="row">
				<div class="col-sm-2 abbr">
					<abbr class="badge rounded w-100">Optagen</abbr>
					<div class="author" style="margin-top: 0.5em; text-align: center;">Python Developer</div>
				</div>
				<div class="col-sm-8">
					<div class="title">Optagen Technologies</div>
